...
void runBenchmark(int inputType)
{
    ...
    for (int iter = 0; iter < 8; iter++)
    {
        ...
        for (int alg = 0; alg < 6; alg++)
        {
            ...
            {
            case 0:
                applyBubbleSort(testArr, size);
                break;
            case 1:
                applyInsertionSort(testArr, size);
                break;
            case 2:
                applySelectionSort(testArr, size);
                break;
            case 3:
                applyQuickSort(testArr, size);
                break;
            case 4:
                applyMergeSort(testArr, size);
                break;
            case 5:
                applyHeapSort(testArr, size);
                break;
            }
